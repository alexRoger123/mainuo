                ...
                <div class="cart box_1">
                    <a href="checkout.html">
                        <h3> <div class="total">
                            ...
                            <img src="{{asset('home/images/bag.png')}}" alt="" />
                        </h3>
                    </a>
...
<div class="banner">
    <div class="container">
        <div class="banner-info animated wow zoomIn" data-wow-delay=".5s">
            ...
            <script src="{{asset('home/js/jquery.wmuSlider.js')}}"></script>
            <script>
                $('.example1').wmuSlider();
            </script>
        </div>
        ...
        <div class="banner-bottom-grids">
            <div class="banner-bottom-grid-left animated wow slideInLeft" data-wow-delay=".5s">
                <div class="grid">
                    <figure class="effect-julia">
                        <img src="{{asset('home/images/4.jpg')}}" alt=" " class="img-responsive" />
                        <figcaption>
            ...
            <div class="banner-bottom-grid-left1 animated wow slideInUp" data-wow-delay=".5s">
                <div class="banner-bottom-grid-left-grid left1-grid grid-left-grid1">
                    <div class="banner-bottom-grid-left-grid1">
                        <img src="{{asset('home/images/1.jpg')}}" alt=" " class="img-responsive" />
                    </div>
                ...
                <div class="banner-bottom-grid-left-grid left1-grid grid-left-grid1">
                    <div class="banner-bottom-grid-left-grid1">
                        <img src="{{asset('home/images/2.jpg')}}" alt=" " class="img-responsive" />
                    </div>
            ...
            <div class="banner-bottom-grid-right animated wow slideInRight" data-wow-delay=".5s">
                <div class="banner-bottom-grid-left-grid grid-left-grid1">
                    <div class="banner-bottom-grid-left-grid1">
                        <img src="{{asset('home/images/3.jpg')}}" alt=" " class="img-responsive" />
                    </div>
        ...
        <div class="new-collections-grids">
            <div class="col-md-3 new-collections-grid">
                <div class="new-collections-grid1 animated wow slideInUp" data-wow-delay=".5s">
                    <div class="new-collections-grid1-image">
                        <a href="single.html" class="product-image"><img src="{{asset('home/images/7.jpg')}}" alt=" " class="img-responsive" /></a>
                        ...
                        <div class="new-collections-grid1-right">
                            <div class="rating">
                                <div class="rating-left">
                                    <img src="{{asset('home/images/2.png')}}" alt=" " class="img-responsive" />
                                </div>
                                <div class="rating-left">
                                    <img src="{{asset('home/images/2.png')}}" alt=" " class="img-responsive" />
                                </div>
                                ...
                                <div class="rating-left">
                                    <img src="{{asset('home/images/1.png')}}" alt=" " class="img-responsive" />
                                </div>
                                <div class="rating-left">
                                    <img src="{{asset('home/images/1.png')}}" alt=" " class="img-responsive" />
                                </div>
                ...
                <div class="new-collections-grid1 animated wow slideInUp" data-wow-delay=".5s">
                    <div class="new-collections-grid1-image">
                        <a href="single.html" class="product-image"><img src="{{asset('home/images/8.jpg')}}" alt=" " class="img-responsive" /></a>
                        <div class="new-collections-grid1-image-pos">
                            <a href="single.html">Quick View</a>
                        </div>
                        <div class="new-collections-grid1-right">
            ...
            <div class="col-md-6 new-collections-grid">
                <div class="new-collections-grid1 new-collections-grid1-image-width animated wow slideInUp" data-wow-delay=".5s">
                    <div class="new-collections-grid1-image">
                        <a href="single.html" class="product-image"><img src="{{asset('home/images/5.jpg')}}" alt=" " class="img-responsive" /></a>
                ...
                <div class="new-collections-grid-sub-grids">
                    <div class="new-collections-grid1-sub">
                        <div class="new-collections-grid1 animated wow slideInUp" data-wow-delay=".5s">
                            <div class="new-collections-grid1-image">
                                <a href="single.html" class="product-image"><img src="{{asset('home/images/6.jpg')}}" alt=" " class="img-responsive" /></a>
                                <div class="new-collections-grid1-image-pos">
                                    <a href="single.html">Quick View</a>
                                </div>
                                <div class="new-collections-grid1-right">
                    ...
                    <div class="new-collections-grid1-sub">
                        <div class="new-collections-grid1 animated wow slideInUp" data-wow-delay=".5s">
                            <div class="new-collections-grid1-image">
                                <a href="single.html" class="product-image"><img src="{{asset('home/images/9.jpg')}}" alt=" " class="img-responsive" /></a>
                                <div class="new-collections-grid1-image-pos">
                                    <a href="single.html">Quick View</a>
                                </div>
                                <div class="new-collections-grid1-right">
            ...
            <div class="col-md-3 new-collections-grid">
                <div class="new-collections-grid1 animated wow slideInUp" data-wow-delay=".5s">
                    <div class="new-collections-grid1-image">
                        <a href="single.html" class="product-image"><img src="{{asset('home/images/10.jpg')}}" alt=" " class="img-responsive" /></a>
                        <div class="new-collections-grid1-image-pos">
                            <a href="single.html">Quick View</a>
                        </div>
                        <div class="new-collections-grid1-right">
                ...
                <div class="new-collections-grid1 animated wow slideInUp" data-wow-delay=".5s">
                    <div class="new-collections-grid1-image">
                        <a href="single.html" class="product-image"><img src="{{asset('home/images/11.jpg')}}" alt=" " class="img-responsive" /></a>
                        <div class="new-collections-grid1-image-pos">
                            <a href="single.html">Quick View</a>
                        </div>
                        <div class="new-collections-grid1-right">
        ...
        <div class="timer-grids">
            ...
            <div class="col-md-4 timer-grid-right animated wow slideInRight" data-wow-delay=".5s">
                <div class="timer-grid-right1">
                    <img src="{{asset('home/images/17.jpg')}}" alt=" " class="img-responsive" />
        ...
        <div class="footer-grids">
            ...
            <div class="col-md-3 footer-grid animated wow slideInLeft" data-wow-delay=".7s">
                ...
                <div class="footer-grid-left">
                    <a href="single.html"><img src="{{asset('home/images/images/13.jpg')}}" alt=" " class="img-responsive" /></a>
                </div>
                <div class="footer-grid-left">
                    <a href="single.html"><img src="{{asset('home/images/images/14.jpg')}}" alt=" " class="img-responsive" /></a>
                </div>
                <div class="footer-grid-left">
                    <a href="single.html"><img src="{{asset('home/images/images/15.jpg')}}" alt=" " class="img-responsive" /></a>
                </div>
                <div class="footer-grid-left">
                    <a href="single.html"><img src="{{asset('home/images/images/16.jpg')}}" alt=" " class="img-responsive" /></a>
                </div>
                <div class="footer-grid-left">
                    <a href="single.html"><img src="{{asset('home/images/images/13.jpg')}}" alt=" " class="img-responsive" /></a>
                </div>
            ...
            <div class="col-md-3 footer-grid animated wow slideInLeft" data-wow-delay=".8s">
                ...
                <div class="footer-grid-sub-grids">
                    <div class="footer-grid-sub-grid-left">
                        <a href="single.html"><img src="{{asset('home/images/images/9.jpg')}}" alt=" " class="img-responsive" /></a>
                    </div>
                ...
                <div class="footer-grid-sub-grids">
                    <div class="footer-grid-sub-grid-left">
                        <a href="single.html"><img src="{{asset('home/images/images/10.jpg')}}" alt=" " class="img-responsive" /></a>
                    </div>
                    <div class="footer-grid-sub-grid-right">
